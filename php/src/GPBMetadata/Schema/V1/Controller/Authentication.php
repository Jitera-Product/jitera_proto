...
/**
 * Generated from protobuf message <code>schema.v1.Controller.Authentication</code>
 */
...
class_alias(Authentication::class, \Schema\V1\Controller_Authentication::class);
