...
/**
 * Generated from protobuf message <code>schema.v1.AddColumn</code>
 */
class AddColumn extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $key = '';
    /**
     * Generated from protobuf field <code>.schema.v1.MigrationColumnDefinition change_to = 2;</code>
     */
    ...
    protected $next_uuid = '';
    /**
     * Generated from protobuf field <code>.schema.v1.MigrationColumnDefinition next_record = 5;</code>
     */
     ...
     *
     *     @type string $key
     *     @type \Schema\V1\MigrationColumnDefinition $change_to
