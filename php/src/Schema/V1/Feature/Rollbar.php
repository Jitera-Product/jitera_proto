...
/**
 * Generated from protobuf message <code>schema.v1.Feature.Rollbar</code>
 */
class Rollbar extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(Rollbar::class, \Schema\V1\Feature_Rollbar::class);
