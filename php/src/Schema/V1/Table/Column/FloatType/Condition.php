...
namespace Schema\V1\Table\Column\FloatType;
...
/**
 * Generated from protobuf message <code>schema.v1.Table.Column.FloatType.Condition</code>
 */
...
class_alias(Condition::class, \Schema\V1\Table_Column_FloatType_Condition::class);
