...
/**
 * Generated from protobuf message <code>schema.v1.Table.Column.StringType.Condition</code>
 */
...
class_alias(Condition::class, \Schema\V1\Table_Column_StringType_Condition::class);
