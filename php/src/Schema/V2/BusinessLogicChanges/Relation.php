...
/**
 * Generated from protobuf message <code>schema.v2.BusinessLogicChanges.Relation</code>
 */
...
class_alias(Relation::class, \Schema\V2\BusinessLogicChanges_Relation::class);
