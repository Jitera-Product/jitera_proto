...
/**
 * Generated from protobuf message <code>schema.v2.BusinessLogicSyncResponse</code>
 */
class BusinessLogicSyncResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $message = '';
    /**
     * Generated from protobuf field <code>.schema.v2.BusinessLogicSyncResponse.Status status = 3;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Schema\V2\BusinessLogicSyncResponse\Status::class);
        $this->status = $var;
