...
namespace Schema\V2\BusinessLogicSyncResponse;

use UnexpectedValueException;

/**
 * Protobuf type <code>schema.v2.BusinessLogicSyncResponse.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Schema\V2\BusinessLogicSyncResponse_Status::class);
