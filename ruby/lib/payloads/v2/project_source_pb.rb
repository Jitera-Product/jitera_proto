...
module Schema
  module V2
    ...
    ControllerConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ControllerConfig").msgclass
    ControllerConfig::Controller = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ControllerConfig.Controller").msgclass
    ControllerConfig::Controller::Endpoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ControllerConfig.Controller.Endpoint").msgclass
