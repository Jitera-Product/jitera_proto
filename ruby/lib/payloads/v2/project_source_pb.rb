...
module Schema
  module V2
    ...
    ProjectPlugin::PluginStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup('schema.v2.ProjectPlugin.PluginStatus').enummodule
