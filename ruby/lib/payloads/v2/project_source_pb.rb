...
module Schema
  module V2
    ...
    BlockChanges = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges").msgclass
    BlockChanges::Block = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges.Block").msgclass
    BlockChanges::Block::Addition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges.Block.Addition").msgclass
    BlockChanges::Block::Modification = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges.Block.Modification").msgclass
    BlockChanges::Block::Deletion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges.Block.Deletion").msgclass
    BlockChanges::BlockBody = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BlockChanges.BlockBody").msgclass
