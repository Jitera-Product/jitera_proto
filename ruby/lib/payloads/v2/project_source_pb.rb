...
module Schema
  module V2
    ...
    ProjectSourceCreation::Git = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ProjectSourceCreation.Git").msgclass
    ...
    ERDConfig::Git = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ERDConfig.Git").msgclass
