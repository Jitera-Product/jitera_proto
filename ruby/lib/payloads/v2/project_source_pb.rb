...
module Schema
  module V2
    ...
    Table = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.Table").msgclass
    Table::Column = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.Table.Column").msgclass
    Table::Relation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.Table.Relation").msgclass
