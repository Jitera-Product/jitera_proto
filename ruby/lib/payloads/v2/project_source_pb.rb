...
module Schema
  module V2
    ...
    ApiChanges::Table = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.Table").msgclass
    ApiChanges::Column = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.Column").msgclass
    ApiChanges::Relation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.Relation").msgclass
