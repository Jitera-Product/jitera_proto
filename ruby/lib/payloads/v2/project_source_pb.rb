...
module Schema
  module V2
    ...
    BusinessLogicChanges::Table = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BusinessLogicChanges.Table").msgclass
    BusinessLogicChanges::Column = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BusinessLogicChanges.Column").msgclass
    BusinessLogicChanges::Relation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.BusinessLogicChanges.Relation").msgclass
    ...
    ApiChanges::ApiSchema = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.ApiSchema").msgclass
    ApiChanges::BusinessLogic = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.BusinessLogic").msgclass
    ApiChanges::RequestItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.ApiChanges.RequestItem").msgclass
