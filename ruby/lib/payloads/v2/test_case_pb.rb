...
module Schema
  module V2
    ...
    TestCaseStepCodeSync = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepCodeSync").msgclass
    TestCaseStepCodeSync::TestConfiguration = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepCodeSync.TestConfiguration").msgclass
  end
end
