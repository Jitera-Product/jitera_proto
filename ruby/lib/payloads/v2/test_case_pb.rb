...
module Schema
  module V2
    ...
    TestCaseStepSync = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepSync").msgclass
    TestCaseStepSync::TestConfiguration = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepSync.TestConfiguration").msgclass
    TestCaseStepSyncReport = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepSyncReport").msgclass
    TestCaseStepSyncReport::Status = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCaseStepSyncReport.Status").enummodule
  end
end
