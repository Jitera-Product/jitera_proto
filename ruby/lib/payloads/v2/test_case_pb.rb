...
module Schema
  module V2
    ...
    TestCasesRegneration = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCasesRegneration").msgclass
    TestCasesRegnerationReport = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCasesRegnerationReport").msgclass
    TestCasesRegnerationReport::Status = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.TestCasesRegnerationReport.Status").enummodule
