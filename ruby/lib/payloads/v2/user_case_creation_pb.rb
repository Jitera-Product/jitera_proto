...
module Schema
  module V2
    ...
    UserCaseCreation::HtmlWireframe = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("schema.v2.UserCaseCreation.HtmlWireframe").msgclass
